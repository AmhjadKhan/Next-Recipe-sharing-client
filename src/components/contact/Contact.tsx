    ...
    <section className="bg-gray-50 py-16 px-8 md:px-20">
      <div className="container mx-auto max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="name" className="block text-left text-gray-800 mb-2">
              Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="email" className="block text-left text-gray-800 mb-2">
              Email
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="message" className="block text-left text-gray-800 mb-2">
              Message
            </label>
            <textarea
              id="message"
